...
type SalesOrderHeaderPropsWithTotalAmount = Omit<SalesOrderHeaderProps, 'id' | 'totalAmount'>;
...
export class SalesOrderHeaderModel {
    ...
    public static create(props: SalesOrderHeaderPropsWithTotalAmount): SalesOrderHeaderModel {
